...
var numBrandsGot = 0;
var brands = ["aveda", "clinique", "m-a-c", "bobbi brown", "bumble and bumble", "estee lauder", "origins", "smashbox", "lab series", "darphin", "rodin", "adf", "jo malone", "tom ford", "estee lauder DIS", "jo malone DIS", "origins DIS", "aveda DIS", "bumble and bumble DIS", "bobbi brown DIS", "m-a-c DIS", "clinique DIS", "la mer", "wips_donations"];
var items = [];
...
var optionsAllProducts = {
    ...
    searchClass: 'search',
    page: 1500,
    item: '<li class="products item"> <aside class="row"> <span class="id"></span> <span class="brand"></span> <span class="isSelected"></span> <div class="productImage"></div><div class="col-xs-9"> <h5><span class="formattedSale"></span> <span class="formattedPrice"></span></h5> <h2 class="prodRgnName"></h2> <h4 class="shadeOrSize"></h4> <div class="qty-container"> <button class="minus">-</button><span class="qty"></span> <button class="plus">+</button> </div></div><div class="col-xs-3 text-center"> <button class="addToWishlist"><span class="glyphicon glyphicon-plus-sign"> </span><span class="glyphicon glyphicon-heart"> </span> </button> </div></aside></li>'
};
...
function addDataToDbFromServer(forBrand,brandUrl,obj,status){
    // console.log("adding from server");
    dbinv.transaction(function (tx) {
        
        
        if (forBrand === "rodin" || forBrand === "adf" || forBrand === "aerin" || forBrand === "tom ford" || forBrand === "jo malone DIS" || forBrand === "origins DIS" || forBrand === "aveda DIS" || forBrand === "bumble and bumble DIS" || forBrand === "bobbi brown DIS" || forBrand === "m-a-c DIS" || forBrand === "clinique DIS" || forBrand === "estee lauder DIS" || forBrand === "la mer") {
...
function addDataToDomFromDb(forBrand,brandUrl) {
...
function getProducts( forBrand ){
    ...
    switch (forBrand) {
        ...
        /*case "aveda":
            var brand = 'aveda';
            var brandUrl = 'http://www.aveda.com';

            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0250/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent,sale';
            break;*/
            
        case "aveda":
            var brand = 'aveda';
            var brandUrl = 'http://www.aveda.com';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/aveda1.json';
            break;
            
        case "aveda DIS":
            var brand = 'aveda';
            var brandUrl = 'http://ota.esteeonline.com/wishlist/images/aveda';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/aveda.json';
            break;
                    
        case "bobbi brown":
            var brand = 'bobbi brown';
            var brandUrl = 'http://www.bobbibrown.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0246/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            // 4 missing
            
        case "bobbi brown DIS":
            var brand = 'bobbi brown';
            var brandUrl = '';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/bobbi.json';
            break;
            
        case "bumble and bumble":
            var brand = 'bumble and bumble';
            var brandUrl = 'http://www.bumbleandbumble.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0247/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            // 2 missing
            
        case "bumble and bumble DIS":
            var brand = 'bumble and bumble';
            var brandUrl = '';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/bumble.json';
            break;
            
        /*case "clinique":
            var brand = 'clinique';
            var brandUrl = 'http://www.clinique.com';
            var filter = 'byProduct';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0025/products?q={"data.collection":"bca"}&select=prodRgnName,largeImage,shaded,skus,sale';
            break;*/
            
        case "clinique":
            var brand = 'clinique';
            var brandUrl = 'http://www.clinique.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0025/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            
        case "clinique DIS":
            var brand = 'clinique';
            var brandUrl = 'http://ota.esteeonline.com/wishlist/images/clinique';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/clinique.json';
            break;
            
        case "darphin":
            var brand = 'darphin';
            var brandUrl = 'http://www.darphin.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0272/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            
        case "estee lauder":
            var brand = 'estee lauder';
            var brandUrl = 'http://www.esteelauder.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0423/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            
        case "estee lauder DIS":
            var brand = 'estee lauder';
            var brandUrl = '';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/estee.json';
            break;
        
        case "jo malone":
            var brand = 'jo malone';
            var brandUrl = 'http://www.jomalone.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0350/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            
        case "jo malone DIS":
            var brand = 'jo malone';
            var brandUrl = 'http://ota.esteeonline.com/wishlist/images/jomalone';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/jomalone.json';
            break;
            
        case "lab series":
            var brand = 'lab series';
            var brandUrl = 'http://www.labseries.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0274/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            
        case "la mer":
            var brand = 'la mer';
            var brandUrl = 'http://www.cremedelamer.com';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/lamer.json';
            break;
            
        case "m-a-c":
            var brand = 'm-a-c';
            var brandUrl = 'http://www.maccosmetics.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0024/skus/?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            
        case "m-a-c DIS":
            var brand = 'm-a-c';
            var brandUrl = 'http://www.maccosmetics.com';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/mac.json';
            break;
            
        case "origins":
            var brand = 'origins';
            var brandUrl = 'http://www.origins.com';
//            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/origins1.json';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0249/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            // 12 missing
        ...
        case "origins DIS":
            var brand = 'origins';
            var brandUrl = '';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/origins.json';
            break;
            
        case "rodin":
            var brand = 'rodin';
            var brandUrl = 'http://ota.esteeonline.com/wishlist/images/rodin';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/rodin2.json';
            break;
            
        case "smashbox":
            var brand = 'smashbox';
            var brandUrl = 'http://www.smashbox.com';
            var layersUrl = 'https://layers.esteeonline.com/api/prodcat/LAYER0248/skus?q={"data.collection":"bca"}&select=shadename,formattedPrice,productSize,largeImage,mediumImage,parent.prodRgnName,parent.largeImage,parent.imageL,sale';
            break;
            
        case "adf":
            var brand = 'adf';
            var brandUrl = 'http://ota.esteeonline.com/wishlist/images/adf';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/adf.json';
            break;
            
        /*case "aerin":
            var brand = 'aerin';
            var brandUrl = 'http://ota.esteeonline.com/wishlist/images/aerin';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/aerin.json';
            break;*/
            
        case "tom ford":
            var brand = 'tom ford';
            var brandUrl = 'http://ota.esteeonline.com/wishlist/images/tomford';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/tomford.json';
            break;
            
        case "wips_donations":
            var brand = 'wips_donations';
            var brandUrl = 'http://ota.esteeonline.com/wishlist/images';
            var layersUrl = 'http://ota.esteeonline.com/wishlist/manifest/wip.json';
            break;
    }
        ...
        $.ajax({
            ...
            addDataToDomFromDb(forBrand,brandUrl);
            ...
            addDataToDbFromServer(forBrand,brandUrl,obj,status);
            addDataToDomFromDb(forBrand,brandUrl);
...
function bySku(data,brand,brandUrl) {
    ...
    for ( var a = 0; a < numSkus; a++) {
        ...
        if (thisProduct.largeImage && thisProduct.largeImage[0] !== '/media/images/products/875x773/sbx_sku_53710_875x773_0.jpg') {
            var thisImage = brandUrl + thisProduct.largeImage[0];
        } else if (thisProduct.mediumImage) {
            var thisImage = brandUrl + thisProduct.mediumImage[0];
        } else if (thisProduct.parent.largeImage && thisProduct.parent.largeImage !== '/media/export/cms/products/402x464/clq_71MC45_402x464.png') {
            var thisImage = brandUrl + thisProduct.parent.largeImage;
            ...
            var thisImage = brandUrl + thisProduct.parent.imageL[0];;
        } else {
            var thisImage = 'images/noimage.png';
        }
...
//        var number = 80;
//        console.log("formatMoneyzzz test: " + formatMoneys(number, 2));
